...
>
> ```
> git remote add upstream https://github.com/akameco/s2s.git
> git fetch upstream
...
Please checkout the [the open issues](https://github.com/akameco/s2s/issues)
